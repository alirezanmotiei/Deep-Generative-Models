...
این مخزن شامل پیاده‌سازی‌ها و گزارش‌های جامع تئوری و عملی برای درس **مدل‌های مولد عمیق (Deep Generative Models)** در **دانشکده مهندسی برق و کامپیوتر دانشگاه تهران** در **نیم‌سال پاییز ۱۴۰۴** تحت نظر **دکتر مصطفی توسلی‌پور** می‌باشد که توسط **علیرضا نجفی مطیعی** (شماره دانشجویی: ۸۱۰۱۰۰۲۲۴) انجام گرفته است:
